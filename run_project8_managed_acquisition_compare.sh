...
REMOTE_OUTPUT_DIR="${REMOTE_ROOT}/project_08_outputs/project_08_managed_acquisition_compare"
LOCAL_OUTPUT_DIR="/home/fotis/hackathon/prior_10.3.26/outputs/project_08_managed_acquisition_compare"
...
ssh -i "${SSH_KEY}" -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null \
  ...
  "${VM_USER_HOST}" \
  "mkdir -p ${REMOTE_PROBE_DIR}/include/stir ${REMOTE_OUTPUT_DIR}"
...
scp -i "${SSH_KEY}" -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null \
  ...
  /home/fotis/hackathon/prior_10.3.26/project_08_stir_cuda_managed_pointers/vm_prototype/managed_acquisition_compare.py \
...
ssh -i "${SSH_KEY}" -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null \
  ...
  "sudo docker exec project8-build bash -lc '
    ...
    mkdir -p /work/project_08_probe/include/stir /work/project_08_outputs/project_08_managed_acquisition_compare
    ...
    LD_LIBRARY_PATH=/work/STIR-install-full-cuda/lib:${LD_LIBRARY_PATH:-} PYTHONPATH=/work/sirf_overlay \
      python3 /work/project_08_probe/managed_acquisition_compare.py \
        --factory /work/project_08_probe/libmanaged_sirf_acquisition_factory.so \
        --output /work/project_08_outputs/project_08_managed_acquisition_compare
  '"
